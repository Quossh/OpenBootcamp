...
console.log(str.length)     // Obtener la longitud de un string
...
let substr_str = str.substr(5, 10)      // substr -> Obsoleto
console.log(substr_str)

// Reemplazar parte de un contenido de una cadena
let cadena = "Hola mi nombre es Alberto"
console.log(cadena)

// Al utilizar strings sólo reemplaza la primera instancia
console.log(cadena.replace('Alberto', 'Pedro'))
